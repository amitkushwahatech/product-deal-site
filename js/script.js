$(window).on("load", function () {
    ...
    // $('.navbar-collapse .navbar-nav .nav-link:nth-child(3)').addClass('active');
    // $('.navbar-collapse .navbar-nav .nav-link:nth-child(2)').removeClass('active');
    
    $( '.navbar-collapse .navbar-nav .nav-link' ).on( 'click', function () {
	$( '.navbar-collapse .navbar-nav .nav-link' ).find( 'a.active' ).removeClass( 'active' );
